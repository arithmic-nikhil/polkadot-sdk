	...
	B: backend::Backend<substrate_test_runtime::Block>,
{
	...
	// A1 -> A2
	let a2 = client
		.new_block_at(a1.hash(), Default::default(), false, Default::default())
		.unwrap()
		.build()
		.unwrap()
		.block;
	...
	// A2 -> A3
	let a3 = client
		.new_block_at(a2.hash(), Default::default(), false, Default::default())
		.unwrap()
		.build()
		.unwrap()
		.block;
	...
	// A3 -> A4
	let a4 = client
		.new_block_at(a3.hash(), Default::default(), false, Default::default())
		.unwrap()
		.build()
		.unwrap()
		.block;
	...
	// A4 -> A5
	let a5 = client
		.new_block_at(a4.hash(), Default::default(), false, Default::default())
		.unwrap()
		.build()
		.unwrap()
		.block;
	...
	// B2 -> B3
	let b3 = client
		.new_block_at(b2.hash(), Default::default(), false, Default::default())
		.unwrap()
		.build()
		.unwrap()
		.block;
	...
	// B3 -> B4
	let b4 = client
		.new_block_at(b3.hash(), Default::default(), false, Default::default())
		.unwrap()
		.build()
		.unwrap()
		.block;
