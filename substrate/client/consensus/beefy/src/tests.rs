...
async fn beefy_importing_justifications() {
	...
	let block_num = 2;
	let builder = full_client.new_block_at(hashof1, Default::default(), false, Default::default()).unwrap();
	let block = builder.build().unwrap().block;
	...
	let block_num = 3;
	let builder = full_client.new_block_at(hashof2, Default::default(), false, Default::default()).unwrap();
	let block = builder.build().unwrap().block;
	...
	let block_num = 4;
	let builder = full_client.new_block_at(hashof3, Default::default(), false, Default::default()).unwrap();
	let block = builder.build().unwrap().block;
